...
fun Application.kanbanModule(
    ...
    routing {
        ...
        taskRoutes(service)
        gitHubRoutes(service, gitHubSyncService)
...
fun createKanbanServer(
    ...
    return embeddedServer(Netty, port = port, host = host) {
        kanbanModule(service, json, gitHubSyncService)
    }
}
...
fun startKanbanServer(
    ...
    val server = createKanbanServer(port, host, service, gitHubSyncService = gitHubSyncService)
